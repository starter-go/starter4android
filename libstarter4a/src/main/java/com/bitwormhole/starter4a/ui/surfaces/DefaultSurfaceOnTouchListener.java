...
public class DefaultSurfaceOnTouchListener implements View.OnTouchListener {

    private final SurfaceContext ic;
    private B2OnTouchContext current;

    public DefaultSurfaceOnTouchListener(SurfaceContext ctx) {
        this.ic = ctx;
    }
